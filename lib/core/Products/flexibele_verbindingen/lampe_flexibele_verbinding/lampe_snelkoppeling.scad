// lampe_snelkoppeling.scad
// LAMPE Quick Coupling Connector (male/female variants)

/**
 * Quick coupling connector (snelkoppeling) for LAMPE variant
